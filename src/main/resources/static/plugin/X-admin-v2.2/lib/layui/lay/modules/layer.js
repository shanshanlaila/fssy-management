...
;!function (e, t) {
    ...
    l.anim = ["layer-anim-00", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], s.pt.config = {
        ...
        // l为doms,e为index n为dom对象,t为iframe的高,a为title栏高，o为按钮栏高
        if (e) {
            ...
            if (t + a + o > $(window).height()) {
                // layero的高度为window高
                n.css({height: $(window).height(), top: (bodyHH-$(window).height()) * 0.5});
                n.find("iframe").css({height: $(window).height()-a-o, top:(bodyHH-$(window).height())*0.5});
            } else {
                n.css({height: t + a + o, top: (bodyHH-(t+a+o))*0.5});
                n.find("iframe").css({height: t, top: (bodyHH-(t+a+o))*0.5});
            }
