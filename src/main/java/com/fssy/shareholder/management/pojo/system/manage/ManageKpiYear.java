package com.fssy.shareholder.management.pojo.system.manage;
...
@Getter
@Setter
@TableName("bs_manage_kpi_year")
public class ManageKpiYear extends BaseModel {

    private static final long serialVersionUID = 5834441056680774213L;
