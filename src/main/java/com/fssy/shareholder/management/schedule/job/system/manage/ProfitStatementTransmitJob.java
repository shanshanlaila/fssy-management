...
//		int theMonthValue = localDateTime.getMonthValue();
		...
		catch (Exception e)
		{
			scheduleAuditLog = new ScheduleAuditLog();
			scheduleAuditLog.setName("系统定时任务");
			scheduleAuditLog.setNote(String.format("【%s】年，【%s】月【利润表】对接系统错误，错误原因：【%s】", twoAgoYear,
		...
		catch (Exception e)
		{
			scheduleAuditLog = new ScheduleAuditLog();
			scheduleAuditLog.setName("系统定时任务");
			scheduleAuditLog.setNote(String.format("【%s】年，【%s】月【利润表】对接系统错误，错误原因：【%s】", lastMonthYear,
...
//			scheduleAuditLog = new ScheduleAuditLog();
//			scheduleAuditLog.setName("系统定时任务");
//			scheduleAuditLog.setNote(String.format("【%s】年，【%s】月【利润表】对接系统错误，错误原因：【%s】", theMonthYear,
