 ...
 * @Description: 利润表初始化定时任务
 * @author Solomon
 * @date 2022年12月26日 上午9:27:18
 */
public class ProfitStatementInitJob implements Job
{
	/**
	 * 利润表数据业务实现类
	 */
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException
	{
		...
		catch (Exception e)
		{
			scheduleAuditLog = new ScheduleAuditLog();
			scheduleAuditLog.setName("系统定时任务");
			scheduleAuditLog.setNote(String.format("【%s】年，【%s】月【利润表】对接系统错误，错误原因：【%s】", year2022,
