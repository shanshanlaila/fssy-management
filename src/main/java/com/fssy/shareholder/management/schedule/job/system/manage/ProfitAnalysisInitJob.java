...
/**
 * @Title: ProfitAnalysisInitJob.java
 * @Description: 变动分析表初始化定时任务
 * @author Solomon
 * @date 2022年12月26日 上午9:19:47
 */
public class ProfitAnalysisInitJob implements Job
{
	/**
	 * 变动分析表功能业务实现类
	 */
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException
	{
		...
		try
		{
			...
			Map<String, Object> result = profitAnalysisService.receiveData(params);
		...
		catch (Exception e)
		{
			scheduleAuditLog = new ScheduleAuditLog();
			scheduleAuditLog.setName("系统定时任务");
			scheduleAuditLog.setNote(String.format("【%s】年，【%s】月【变动分析表】对接系统错误，错误原因：【%s】", year2022,
