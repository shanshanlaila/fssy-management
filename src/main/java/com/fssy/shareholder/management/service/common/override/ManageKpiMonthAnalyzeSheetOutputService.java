...
/**
 * @author Shizn
 * @ClassName: ManageKpiMonthAnalyzeSheetOutputService
 * @Description: 月度风险分析 导出excel模板
 * @date 2022/10/21 0021 14:30
 */
public class ManageKpiMonthAnalyzeSheetOutputService extends SheetOutputService {
    /**
     * 重写自定义表头
     *
    ...
    public <T> int customizedHead(XSSFSheet sheet, List<T> list) {
        ...
        CellRangeAddress December = new CellRangeAddress(2, 2,
                ...
                SheetService.columnToIndex("AV"));
        //分析月份
        CellRangeAddress analyzeDesc = new CellRangeAddress(2, 2,
                SheetService.columnToIndex("AW"),
                SheetService.columnToIndex("AX"));

        sheet.addMergedRegion(analyzeDesc);
