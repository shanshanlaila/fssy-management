...
/**
 * <p>
 * *****业务部门：	绩效科		*****数据表中文名：	员工月度评价情况关联主担用户关系表		*****数据表名：	bs_performance_state_relation_main_user		*****数据表作用：	员工月度评价情况关联主担用户关系		*****变更记录：	时间         	变更人		变更内容	20220915	兰宇铧           	初始设计 服务实现类
 * </p>
 *
 * @author shanshan
 * @since 2022-10-28
 */
@Service
public class StateRelationMainUserServiceImpl extends ServiceImpl<StateRelationMainUserMapper, StateRelationMainUser> implements StateRelationMainUserService {
