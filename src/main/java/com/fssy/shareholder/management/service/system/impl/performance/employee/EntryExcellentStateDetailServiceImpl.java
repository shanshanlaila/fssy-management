...
//        }
    ...
    public boolean updateEntryExcellentStateDetail(EntryExcellentStateDetail entryExcellentStateDetail) {
        ...
        entryExcellentStateDetailMapper.update(entryExcellentStateDetail,
                new LambdaUpdateWrapper<EntryExcellentStateDetail>().eq(EntryExcellentStateDetail::getId, entryExcellentStateDetail.getId()));
        return result > 0;
    }
