 ...
 */
@Controller
@RequestMapping("/system/operate/invest/ProjectAttachmentList/")
public class ProjectAttachmentListController {
    @Autowired
    ...
    public String showImportPage(Model model)
    {
        ...
        return "system/operate/invest/project-attachment-list";
    }

    @PostMapping("uploadFile")
    @RequiredLog("年度投资项目清单附件上传")
    @ResponseBody
    public SysResult uploadFile(@RequestParam("file") MultipartFile file, Attachment attachment, HttpServletRequest request) {
        ...
        try {
            //读取附件并保存数据
            Map<String, Object> resultMap = investProjectListService.readInvestProjectListDataSource(result);
