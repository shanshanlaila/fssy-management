...
import com.fssy.shareholder.management.pojo.system.hr.performance.manage_kpi.ManageKpiYear;
...
import com.fssy.shareholder.management.service.system.hr.performance.manage_kpi.ManageKpiYearService;
...
@Controller
@RequestMapping("/system/performance/manager_kpi/manage-kpi-year/")
public class ManageKpiYearController {

    @Autowired
    private ManageKpiYearService manageKpiYearService;
    @Autowired
    ...
    @RequiresPermissions("system:performance:manager_kpi:manage-kpi-year:index1")
    public String manageIndex(Model model) {
        Map<String, Object> params = new HashMap<>();
        return "system/performance/manager_kpi/manage-kpi-year/manage-kpi-year-list";
    }
    ...
    public Map<String, Object> getManageKpiYearDatas(HttpServletRequest request) {
        ...
        Page<ManageKpiYear> manageKpiYearDataListPerPageByParams = manageKpiYearService.findManageKpiYearDataListPerPageByParams(params);
        if (manageKpiYearDataListPerPageByParams.getTotal() == 0) {
            result.put("code", 404);
            result.put("msg", "未查出数据");
        } else {
            result.put("code", 0);
            result.put("count", manageKpiYearDataListPerPageByParams.getTotal());
            result.put("data", manageKpiYearDataListPerPageByParams.getRecords());
        }
        return result;
    }
    ...
    @RequiredLog("附件上传")
    @GetMapping("index")
    @RequiresPermissions("system:performance:manager_kpi:manage-kpi-year:index")
    public String materialDataAttachmentIndex(Model model) {
        ...
        return "system/performance/manager_kpi/manage-kpi-year/manage-kpi-year-attachment-list";
    }
    ...
    private Map<String, Object> getParams(HttpServletRequest request) {
        ...
        if (!ObjectUtils.isEmpty(request.getParameter("kpiLibId"))) {
            params.put("kpiLibId", request.getParameter("kpiLibId"));
        }
