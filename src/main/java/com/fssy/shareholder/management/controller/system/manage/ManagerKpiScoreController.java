...
import com.fssy.shareholder.management.pojo.system.manage.ManagerKpiScore;
import com.fssy.shareholder.management.service.system.manage.ManagerKpiScoreService;
 ...
 */
@Controller
@RequestMapping("/system/manager/manager-month-score/")
public class ManagerKpiScoreController {
    ...
    @RequiresPermissions("system:manager:manager-month-score:index")
    public String manageIndex(Model model) {
        Map<String, Object> params = new HashMap<>();
        return "system/manager/manager-month-score/manager-month-score-list";
    }
