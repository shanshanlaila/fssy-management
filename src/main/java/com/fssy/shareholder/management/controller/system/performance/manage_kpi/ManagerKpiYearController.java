...
public class ManagerKpiYearController {
    ...
    @RequiresPermissions("system:performance:manager_kpi:manager-kpi-year:index1")
    @GetMapping("index1")
    public String manageIndex(Model model){
        Map<String, Object> params = new HashMap<>();
        return "/system/performance/manager_kpi/manager-kpi-year/manager-kpi-year-list";
    }
...
//        }
     ...
     */
    @RequiredLog("附件上传")
    @RequiresPermissions("system:performance:manager_kpi:manager-kpi-year:index")
    @GetMapping("index")
    public String materialDataAttachmentIndex(Model model){
        ...
        return "/system/performance/manager_kpi/manager-kpi-year/manager-kpi-year-attachment-list";
    }
    /**
     * 附件上传
