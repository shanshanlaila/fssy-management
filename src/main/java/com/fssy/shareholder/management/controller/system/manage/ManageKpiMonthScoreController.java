...
import com.fssy.shareholder.management.service.system.manage.ManageKpiMonthScoreService;
 ...
 */
@Controller
@RequestMapping("/system/manager/manage-kpi-month-score/")
public class ManageKpiMonthScoreController {
     ...
     */
    @GetMapping("index1")
    @RequiresPermissions("system:manager:manage-kpi-month-score:index1")
    @RequiredLog("经营管理月度项目分数管理")
    public String manageIndex(Model model) {
        Map<String, Object> params = new HashMap<>();
        return "system/manager/manage-kpi-month-score/manage-kpi-month-score-list";
    }
